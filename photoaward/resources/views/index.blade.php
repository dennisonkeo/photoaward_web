			...
			<div id="stage">
				...
				<div id="site-nam">
					...
					<div id="clockdiv">
						...
						<div id="makeMeScrollable" style="height: 150px;">
							<img src="{{ asset('images/demo/field.jpg') }}" alt="Demo image" id="field" />
							<a href="https://www.google.com/"> <img src="images/demo/gnome.jpg" alt="Demo image" id="gnome" /></a>
