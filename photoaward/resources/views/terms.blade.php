...
<div id="header">
    ...
    <div id="gnavi" class="nav">
      <div class="nav-btn">
        <a href="#gnavi-links">
          ...
          <span class="label">Conditions Of Entry</span>
        </a>
      </div>
    </div>
  ...
  <div class="tabled-th">
    <h2 style="text-transform: uppercase;">Conditions Of Entry</h2>
  </div>
...
<!-- <h3 style="text-transform: uppercase;">Conditions Of Entry:</h3><br><hr> --><hr>
        <p>
        By submitting entries for the Competition, entrants hold the Sponsors and their respective directors, agents, officers, employees, interns, research associates, volunteers and partners (the “Indemnified Parties”)  harmless from and against all claims of any nature arising in connection with entrant’s participation in the contest and acceptance or use of a prize.
        </p>
        <p>
        ...
        <p>
        The contest is void where prohibited or restricted by law. The Sponsors reserve the right to cancel the contest or modify these rules at its discretion. In the event of a dispute regarding the winners, the sponsor reserves the right to award or not award the prizes in its sole discretion.
        </p>
