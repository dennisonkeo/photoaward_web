						...
						@include('errors')
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
								...
								<div class="panel-heading">
									<h3 class="panel-title" style="font-weight: bold;"><i class='fa fa-user-o' style="margin-right: 10px;"></i>Admin Details</h3>
								</div>
							<div class="panel-body">
 								<form method="POST" action="add-moderator">
 								{{ csrf_field() }}
                          			<label>Full Name</label>                       
									<input type="text" class="form-control input-lg" placeholder="" name="name" value=" ">
									<br>
