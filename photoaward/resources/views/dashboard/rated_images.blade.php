    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12 ">
              <h3 class="site-section-heading text-center">Rated Images</h3>
            </div>
          </div>
        </div>
      ...
      @foreach($images as $image)
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item" data-aos="fade" data-src="{{ asset('uploads') }}/{{ $image->upload->imageName }}" data-sub-html="<h4>Author</h4><p>Image caption</p>" style="" >
          <a href="#">
            <img src="{{ route('image-resize',$image->upload->imageName) }}" alt="Image" class="img-fluid" style="heiht: 100px;">
          </a>
          <button style="margin-top: 3px;" class="btn_publishc btn btn-primary btn-block" data-id="{{ $image->upload->id }}">Rated
          </button>
        </div>
