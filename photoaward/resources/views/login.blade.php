...
<!-- <div class="parallax"></div> -->
	...
	<div class="tabled-td" style="height: 400px;">
		<div lang="en">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" style="margin-top: -100px;" method="POST" action="{{ route('user-login') }}">
					...
					<div class="wrap-input100 validate-input" data-validate= "Email/Phone is required" style="margin: 5px;">
						<span class="label-input100">Email/Phone</span>
						<input class="input100" type="text" name="username" placeholder="Enter phone or email...">
					...
					<div class="container-login100-form-btn" >
						...
						<a href="{{ route('registration') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Sign up
